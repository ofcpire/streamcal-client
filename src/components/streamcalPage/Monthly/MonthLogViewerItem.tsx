...
export default function MonthLogViewerItem({
  ...
  return (
    <div className="flex sm:flex-col sm:min-h-[100px] rounded bg-white dark:bg-scDarkColor m-1 ">
      <span
        className={
          'block border-r sm:border-b sm:border-r-0 dark:border-scBrightDarkColor text-center rounded-l' +
          ' ' +
          'sm:rounded-t sm:rounded-bl-none text-sm font-semibold p-2 sm:p-0 min-w-[40px]' +
          ' ' +
          (dateLog.type === 's'
